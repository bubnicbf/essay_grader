...
import Spellings.Spellings as spell
...
#Statistics
wordCount = stat.getWordCount(essay)
sentCount = stat.getSentenceCount(essay)
paraCount = stat.getParaCount(essay)
avgSentLen = stat.getAvgSentenceLength(essay)
stdDevSentLen = stat.getStdDevSentenceLength(essay)
...
#Spellings
numMisspelt, misspeltWordSug = spell.spellCheck(essay)
...
# #Grammar
# grammarCumScore, grammarSentScore = gram.getGrammarScore(essay)
...
overallScore = str(format((((1-(float(numMisspelt)/wordCount))*5) + coherenceScore)/3, '.2f'))
print ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
